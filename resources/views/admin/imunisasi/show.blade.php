...
@section('page-description', 'Lihat rincian pelayanan imunisasi balita yang telah dicatat.')
...
<div class="space-y-5">
    <div class="border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                <h3 class="text-xl font-semibold text-slate-800">Rincian Imunisasi</h3>
                <p class="mt-1 text-sm text-slate-500">Informasi lengkap pelayanan imunisasi untuk balita yang dipilih.</p>
            </div>

            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('admin.imunisasi.edit', $imunisasi) }}" class="inline-flex items-center justify-center border border-amber-500 px-4 py-2.5 text-sm font-medium text-amber-600 transition hover:bg-amber-500 hover:text-white">
                    Edit Data
                </a>
                <a href="{{ route('admin.imunisasi.index') }}" class="inline-flex items-center justify-center border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:border-slate-400 hover:text-slate-800">
                    Kembali
                </a>
            </div>
        </div>
    ...
    <div class="border border-slate-200 bg-white p-5 shadow-sm">
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div class="border border-slate-200 p-4">
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Tanggal Imunisasi</p>
