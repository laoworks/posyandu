    ...
    <div class="border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        {{ $balitum->jenis_kelamin === 'L' ? 'Laki-Laki' : 'Perempuan' }} ·
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('admin.balita.edit', $balitum) }}" class="inline-flex min-w-[108px] items-center justify-center border border-amber-500 px-4 py-2.5 text-sm font-medium text-amber-600 transition hover:bg-amber-500 hover:text-white">
                    Edit Data
                </a>
                <a href="{{ route('admin.balita.index') }}" class="inline-flex min-w-[108px] items-center justify-center border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:border-slate-400 hover:text-slate-800">
                    Kembali
                </a>
            </div>
        </div>
