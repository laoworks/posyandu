...
@section('page-description', 'Lihat informasi lengkap jadwal posyandu yang akan datang.')
...
<div class="space-y-5">
    <div class="border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                <h3 class="text-xl font-semibold text-slate-800">Detail Jadwal Posyandu</h3>
                <p class="mt-1 text-sm text-slate-500">Informasi lengkap jadwal layanan yang bisa Anda ikuti.</p>
            </div>

            <a href="{{ route('orangtua.jadwal.index') }}" class="inline-flex items-center justify-center border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:border-slate-400 hover:text-slate-800">
                Kembali
            </a>
        </div>
    </div>
