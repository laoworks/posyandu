    ...
    <div class="border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('bidan.imunisasi.edit', $imunisasi) }}" class="inline-flex items-center justify-center border border-amber-500 px-4 py-2.5 text-sm font-medium text-amber-600 transition hover:bg-amber-500 hover:text-white">
                    Edit Data
                </a>
                <a href="{{ route('bidan.imunisasi.index') }}" class="inline-flex items-center justify-center border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:border-slate-400 hover:text-slate-800">
                    Kembali
                </a>
            </div>
        </div>
